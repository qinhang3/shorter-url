...
public class MqUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ContentResponse res1= httpClient.GET("http://www.baidu.com");

        System.out.println(res1.getContent());


        Properties properties=new Properties();
        properties.load(MqUtil.class.getClassLoader().getResourceAsStream("user.properties"));
